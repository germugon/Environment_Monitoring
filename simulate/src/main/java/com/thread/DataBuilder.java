...
import com.entity.OriginalData;
...
public class DataBuilder implements Runnable{
	...
	protected static final Logger logger = Logger.getLogger(DataBuilder.class);	
	
	public DataBuilder( String device ) {
...
//		originalDataList.add( new OriginalData("WindDir",random(300,0,360,60),time) );
	...
	public void pushData() {
		...
		for( OriginalData originalData : originalDataList ) {
			...
			System.out.println( "device:" + device + "\tname:" + name + "\tvalue:" + value + "\ttime:" + DateUtil.date2String(time) );
			/////////////////////////////////////////
		}
	}
